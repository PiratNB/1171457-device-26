var popupWriteLink = document.querySelector(".main-contacts_btn"),
    ...
    popupMapLink = document.querySelector(".main-contacts_map"),
    popupMap = document.querySelector(".popup-map"),
    popupWriteClose = document.querySelector(".popup-write-us_close"),
    popupMapClose = document.querySelector(".popup-map_close");
